...
<section>
    ...
    <div class="cinemas-grid">
        @php
            $allCinemas = [
                ['name' => 'MoovyMoovy Pavilion KL', 'loc' => 'Bukit Bintang, Kuala Lumpur', 'tags' => ['IMAX', 'Dolby', 'Couple']],
                ...
                ['name' => 'MoovyMoovy KLCC', 'loc' => 'Kuala Lumpur', 'tags' => ['4DX', 'Couple', 'Dolby']],
                ...
                ['name' => 'MoovyMoovy Queensbay', 'loc' => 'Bayan Lepas, Penang', 'tags' => ['4DX', 'Couple']],
                ...
                ['name' => 'MoovyMoovy Ipoh Parade', 'loc' => 'Ipoh, Perak', 'tags' => ['Dolby', 'Couple']],
