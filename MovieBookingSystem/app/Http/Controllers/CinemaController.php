...
class CinemaController extends Controller
{
    ...
    private array $cinemas = [
        ['id' => 1,  'name' => 'MoovyMoovy Pavilion KL',    'state' => 'Kuala Lumpur', 'loc' => 'Bukit Bintang, Kuala Lumpur', 'tags' => ['IMAX', 'Dolby', 'Couple']],
        ...
        ['id' => 5,  'name' => 'MoovyMoovy KLCC',           'state' => 'Kuala Lumpur', 'loc' => 'Kuala Lumpur',              'tags' => ['4DX', 'Couple', 'Dolby']],
        ...
        ['id' => 8,  'name' => 'MoovyMoovy Queensbay',      'state' => 'Penang',       'loc' => 'Bayan Lepas, Penang',        'tags' => ['4DX', 'Couple']],
        ...
        ['id' => 11, 'name' => 'MoovyMoovy Ipoh Parade',    'state' => 'Perak',        'loc' => 'Ipoh, Perak',                'tags' => ['Dolby', 'Couple']],
