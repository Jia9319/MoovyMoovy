...
<div class="rest-content">
    <section style="padding:3rem clamp(1rem,5vw,3.25rem) 4.5rem;">
        <div class="sec-head">
            ...
            <a href="{{ route('movies.index') }}" class="sec-more">View All →</a>
        </div>
        ...
        <div class="movies-grid">
            ...
            <div class="mcard" onclick="location.href='{{ route('movies.show', $movie->id) }}'">
                <div class="mthumb">
                    ...
                    @endif
                    <div class="moverlay">
                        <a href="{{ route('booking.select', ['movie_id' => $movie->id, 'title' => $movie->title, 'genre' => $movie->genre, 'duration' => $movie->duration]) }}" class="mbtn">Book Ticket</a>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const movies = {!! json_encode($featuredMovies) !!};
    ...
    function updateSlide() {
        ...
        if (movieMeta) {
            let metaHtml = '<span class="rating">★ ' + (movie.rating || '0.0') + '</span>' +
                '<span class="dot">•</span><span>' + (movie.duration || 'N/A') + ' min</span>' +
