                ...
                <div className="payment-main">
                    ...
                    <div className="payment-grid">
                        ...
                        <div className="card-block">
                            ...
                            {initialData.isTuesday ? (
                                <>
                                    <div className="line"><span>Tuesday Discount (50%)</span><strong style={{ color: '#22c55e' }}>- RM {formatCurrency(initialData.discountAmount)}</strong></div>
                                    <div className="line"><span>Seat Total After Discount</span><strong>RM {formatCurrency(initialData.discountedSeatTotal)}</strong></div>
                                </>
                            ) : null}
                    ...
                    <form method="POST" action={initialData.nextUrl} className="pay-form">
                        ...
                        {initialData.isTuesday ? (
                            <p style={{ margin: '0.5rem 0 0.8rem', color: '#22c55e', fontSize: '0.9rem' }}>
